...
<div class="page-header">
  <h1>Issued Certificates List (Obsolete)</h1>
</div>

<div class="issued-container">

  <div class="obsolete-notice">
    <strong>Notice:</strong> This page lists certificates issued under KISTI Grid CA v2.0, which is no longer accredited by IGTF.
    For current certificates, please visit <a href="/issued_v3/">Issued Certificates (v3.0)</a>.
  </div>

  <div class="issuer-info">
    <strong>Issuer Subject:</strong>
    <code>C=KR, O=KISTI, O=GRID, CN=KISTI Grid Certificate Authority</code>
  </div>
