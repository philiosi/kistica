<?php
/**
 * KISTI CA - CA Admin Portal Header
...
function isNavActive($href, $currentPage) {
  if ($href === '/' || $href === '/index.php' || $href === 'index.php') {
    return preg_match('#/ca/?$#', $currentPage) || preg_match('#/ca/index\.php#', $currentPage);
  }
...
<head>
  ...
  <title>KISTI CA - CA Admin Portal</title>
  ...
  <aside class="hidden md:flex flex-col w-56 bg-white border-r border-slate-200 fixed h-full">
    ...
    <div class="p-4 border-b border-slate-200">
      <a href="<?=$pkiBasePath?>/" class="flex items-center gap-2">
        ...
        <div>
          <p class="font-bold text-slate-900">CA Admin</p>
    ...
    <nav class="flex-1 overflow-y-auto p-2">
      ...
      <a href="<?=$pkiBasePath?>/wacc_v3.php" class="nav-item <?=isNavActive('wacc_v3.php', $currentPage) ? 'active' : ''?>">
      ...
      <a href="<?=$pkiBasePath?>/issued_v3.php" class="nav-item <?=isNavActive('issued_v3.php', $currentPage) ? 'active' : ''?>">
        <span class="material-symbols-outlined">history</span>
        Issued Certs
      </a>
      <a href="http://ca.gridcenter.or.kr/crl.php" target="_blank" class="nav-item">
    ...
    <header class="md:hidden sticky top-0 z-50 bg-background-light/80 backdrop-blur-md border-b border-slate-200">
      <div class="flex items-center justify-center p-4">
        <div class="flex items-center gap-2">
          <div class="bg-red-500/10 p-1.5 rounded-lg text-red-600">
            <span class="material-symbols-outlined text-lg">admin_panel_settings</span>
          </div>
          <h2 class="text-red-600 font-bold text-lg">CA Admin</h2>
        </div>
      </div>
    </header>
