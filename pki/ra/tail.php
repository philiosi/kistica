<?php
/**
 * KISTI CA - RA Admin Portal Footer
...
?>
    ...
    <footer class="hidden md:block bg-white border-t border-slate-200 mt-auto">
      <div class="p-6 text-center text-sm text-slate-500">
        ...
        <p class="mt-1 text-slate-400">RA Admin Portal v3.0</p>
      </div>
    </footer>
...
<footer class="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-slate-200 pb-safe z-30">
  <div class="flex justify-around items-center pt-2 pb-1">
    <a href="<?=$pkiBasePath?>/" class="bottom-tab <?=preg_match('#/ra/?$#', $currentPage) || preg_match('#/ra/index\.php#', $currentPage) ? 'active' : ''?>">
      <span class="material-symbols-outlined">home</span>
      <span>Home</span>
    </a>
    <a href="<?=$pkiBasePath?>/newsubscriber_v3.php" class="bottom-tab <?=strpos($currentPage, 'newsubscriber') !== false ? 'active' : ''?>">
    ...
    <a href="http://ca.gridcenter.or.kr/" target="_blank" class="bottom-tab">
