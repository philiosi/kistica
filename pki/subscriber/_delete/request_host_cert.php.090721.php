...
//////////////////////// requeest user certificate ///////////////////


  include("head.php");

  $title = "Request Host Certificate";
  ParagraphTitle($title);

  print<<<EOS
<p style="line-height:160%;">
<b>Step 1</b>. Generate a CSR for your host.<br>
</p>

<p style="line-height:160%;">
<b>Step 2</b>. Upload the CSR using the following form.<br>
</p>
<style>
...
<tr>
 ...
 <td class='b'>
<!--
   <input type='text' name='dnc_o' size='30' maxlength='30'>
   (max. 30 characters)
-->
  <select name='dnc_o'>
   <option value=''></option>
...
<tr>
 <td class='a'>Host FQDN:</td>
 <td class='b'><input type='text' name='dnc_cn' size='30' maxlength='30'>
   (max. 30 characters)<br>
  e.g) hostname.example.co.kr
 </td>
</tr>
<tr>
 <td class='a'>CSR:</td>
 <td class='b'>
  Copy and paste your CSR block below:<br>
  <textarea name='csr'  cols='60' rows='10'></textarea>
 </td>
</tr>
EOS;
...
<tr>
 <td class='c' colspan='2'>
   ...
   <input type='button' name='ubtn' value=' Upload CSR ' onclick="upload_csr()">
 </td>
</tr>
</form>
</table>
...
Sub generate_csr
  ...
  if (Form.dnc_fn.value = "") Then
    MsgBox ("Please Fill the Form")
    Exit Sub
  end if
  if (Form.dnc_ln.value = "") Then
    MsgBox ("Please Fill the Form")
    Exit Sub
  end if
  ...
  szName = szName + ";CN=" & Form.dnc_fn.value+" "+Form.dnc_ln.value
