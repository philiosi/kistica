...
<tr>
 ...
 <td class='b'>
<!--
   <input type='text' name='dnc_o' size='30' maxlength='30'><br>
   (max. 30 characters)
-->
  <select name='dnc_o'>
   <option value=''></option>
...
<tr>
 ...
 <td class='b'>
   <input type='text' name='dnc_cn' size='40' maxlength='40' value='$cn' readonly>(read only)<br>
   (max. 40 characters)
 </td>
</tr>
<tr>
 <td class='c' colspan='2'>
   ...
   <input type='button' value=' Generate CSR ' name='btn_gencsr'
     onclick="generate_csr" language="VBScript">
 </td>
</tr>
</table>
<br>
